...
<main>
	<div class="parallax-container" style="margin-left-1px;">
		<div class="parallax"><img src="../resources/images/seriea.jpg"/></div>
	</div>
	<div class="section white">
		<h2 class="header" style="text-align:center; margin-left:-75px">Serie A</h2>
		<p class="grey-text text-darken-3 lighten-3" style="text-align:center; margin-left:-75px">Italian Soccer League. The most interesting league</p>
