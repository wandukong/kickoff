...
<main>
	<div class="parallax-container" style="margin-left-1px;">
		<div class="parallax"><img src="../resources/images/bundesliga.jpg"/></div>
	</div>
	<div class="section white">
		<h2 class="header" style="text-align:center; margin-left:-75px">BundesLiga</h2>
		<p class="grey-text text-darken-3 lighten-3" style="text-align:center; margin-left:-75px"> German soccer League. The highest average attendance of any football league in the world. </p>
